...
st.markdown("<h3 style='color:steelblue;'>Part IV: Data Analysis</h3>", unsafe_allow_html=True)
st.write("I kindly invite you to check the python notebook for the section of data analysis. Thank you!")
